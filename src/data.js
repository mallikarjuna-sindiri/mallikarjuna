...
import oracleGenAi from './images/certificates/oracle_genai.png';
import gccf from './images/certificates/gccf.png';
import ibmAi from './images/certificates/ibm_ai.png';
import tataStrive from './images/certificates/tata_strive.png';
import pwcLaunchpad from './images/certificates/pwc_launchpad.png';
import infosysPython from './images/certificates/infosys_python.png';
import tableau from './images/certificates/tableau.png';
import infosysJava from './images/certificates/infosys_java.png';
...
export const certifications = [
  {
    ...
    shortTitle: 'Generative AI Professional',
    issuer: 'Oracle University',
    date: '2025',
    validity: 'Valid until Oct 29, 2027',
    category: 'Generative AI',
    level: 'Professional Certification',
    featured: true,
    image: oracleGenAi,
    description: 'Specialized credential validating expertise in OCI Generative AI services, LLM fine-tuning, RAG architecture, and model deployment.',
  },
  {
    id: 'gccf',
    title: 'Google Cloud Career Launchpad — Computing Foundations',
    shortTitle: 'Computing Foundations',
    issuer: 'Google Cloud',
    date: 'May 3, 2026',
    ...
    featured: true,
    image: gccf,
    description: 'Core computing foundations certificate covering GCP architecture, cloud infrastructure, virtualization, and networking.',
  },
  {
    id: 'ibm-ai',
    ...
    level: 'Core Credential',
    featured: true,
    image: ibmAi,
    description: 'Foundational AI credential covering machine learning algorithms, deep learning concepts, AI ethics, and neural networks.',
  },
  {
    id: 'infosys-java',
    ...
    level: 'Technical Credential',
    featured: true,
    image: infosysJava,
    description: 'Object-oriented programming concepts, core Java syntax, multi-threading, and backend application structure.',
  },
  {
    id: 'pwc-launchpad',
    title: 'Advisory Launchpad Program',
    shortTitle: 'Advisory Launchpad',
    issuer: 'PwC',
    date: 'August 7, 2026',
    validity: 'Certificate of Participation',
    category: 'Professional Development',
    level: 'Industry Exposure',
    featured: true,
    image: pwcLaunchpad,
    description: 'Industry training on cloud consulting, enterprise technology advising, system design, and strategic problem solving.',
  },
  {
    id: 'infosys-python',
    title: 'Basics of Python',
    shortTitle: 'Basics of Python',
    issuer: 'Infosys Springboard',
    ...
    featured: true,
    image: infosysPython,
    description: 'Core Python programming certification covering data structures, object-oriented concepts, and algorithmic problem solving.',
  },
  {
    id: 'ibm-skillup',
    title: 'Artificial Intelligence Fundamentals | SkillUp 2024',
    shortTitle: 'AI Fundamentals (SkillUp)',
    issuer: 'IBM SkillsBuild',
    date: 'August 23, 2024',
    validity: 'SkillUp 2024 Edition',
    category: 'Artificial Intelligence',
    level: 'Specialization',
    featured: false,
    image: ibmAi,
    description: 'SkillUp 2024 specialized credential in artificial intelligence applications and data science workflows.',
  },
  {
    id: 'tableau',
    title: 'Data Visualisation using Tableau',
    ...
    featured: false,
    image: tableau,
    description: 'Comprehensive certification in building interactive Tableau dashboards, metric tracking, and visual analytics.',
  },
  {
    id: 'cyber-suraksha',
    title: 'Cyber Suraksha',
    shortTitle: 'Cyber Suraksha (40-hr)',
    issuer: 'Tata STRIVE × Microsoft',
    date: 'May 23, 2024',
    validity: '40-Hour Online Course',
    category: 'Cybersecurity',
    level: 'Technical Credential',
    featured: false,
    image: tataStrive,
    description: 'Practical training on threat detection, network security, data protection, and enterprise cybersecurity hygiene.',
  },
];
